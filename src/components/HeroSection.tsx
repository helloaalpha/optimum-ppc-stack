    ...
    <section className="pt-40 pb-28 md:pt-48 md:pb-32 px-6 bg-white">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-5 gap-12 items-start">
          <div className="text-left md:col-span-3 text-fade-in">
            ...
            <div className="mt-12">
              <Button className="bg-ppc-black hover:bg-ppc-black/90 text-white text-lg py-7 px-10 rounded-full subtle-hover">
                Start Free Today
              </Button>
          ...
          <div className="md:col-span-2 border border-gray-200 rounded-xl overflow-hidden shadow-sm fade-in">
